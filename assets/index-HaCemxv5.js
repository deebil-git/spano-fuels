...
`;document.head.appendChild(S);const C={threshold:.1,rootMargin:"0px 0px -50px 0px"},I=new IntersectionObserver(e=>{e.forEach(t=>{t.isIntersecting&&(t.target.classList.add("fade-in-up"),I.unobserve(t.target))})},C);document.querySelectorAll(".service-card, .stat-item, .about-text, .about-image").forEach(e=>{I.observe(e)});function P(){const e=document.querySelector(".footer-bottom-content p");if(e){const t=new Date().getFullYear();e.innerHTML=`&copy; ${t} Spano Fuels. All rights reserved.`}}document.addEventListener("DOMContentLoaded",P);const f=document.querySelectorAll(".map-tab"),F=document.querySelectorAll(".map-link-btn"),m=document.getElementById("locationMap"),g={warehouse:{url:"https://maps.app.goo.gl/CwZV6z9kGXuPxCA8A",embed:"https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d115375.08101179777!2d55.4644395!3d25.355517!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f593483214af3%3A0x957ebfa2e1ff5d38!2sSpano%20Fuel%20Supply%20Services%20LLC!5e0!3m2!1sen!2s!4v1760511087255!5m2!1sen!2s"},office:{url:"https://maps.app.goo.gl/nmGX1AqdLcgBtmKs9",embed:"https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d115412.06746799707!2d55.3164674!3d25.3167295!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f5d44934a8563%3A0xd90f42421629e676!2sSpano%20Fuel%20Supply%20Services%20LLC!5e0!3m2!1sen!2s!4v1760511110277!5m2!1sen!2s"}};m&&(m.src=g.warehouse.embed);f.length>0&&f.forEach(e=>{e.addEventListener("click",function(){const t=this.getAttribute("data-location");f.forEach(n=>n.classList.remove("active")),this.classList.add("active"),F.forEach(n=>{n.classList.remove("active"),n.classList.contains(`${t}-link`)&&n.classList.add("active")}),m&&g[t]&&(m.src=g[t].embed)})});console.log("%c Welcome to Spano Fuels! ","background: #c41e3a; color: white; font-size: 16px; padding: 10px;");console.log("%c Premier Fuel Supply Services in UAE ","background: #1a472a; color: white; font-size: 14px; padding: 8px;");const a=document.getElementById("lightbox"),b=document.getElementById("lightbox-img"),M=document.getElementById("lightbox-counter"),x=document.getElementById("lightbox-close"),L=document.getElementById("lightbox-prev"),E=document.getElementById("lightbox-next"),k=document.querySelectorAll(".gallery-item");let c=0;const r=Array.from(k).map(e=>({src:e.querySelector("img").src,alt:e.querySelector("img").alt}));function $(e){c=e,h(),a.classList.add("active"),document.body.style.overflow="hidden"}function p(){a.classList.remove("active"),document.body.style.overflow=""}function h(){r[c]&&(b.src=r[c].src,b.alt=r[c].alt,M.textContent=`${c+1} / ${r.length}`)}function A(){c=(c+1)%r.length,h()}function q(){c=(c-1+r.length)%r.length,h()}k.forEach((e,t)=>{e.addEventListener("click",()=>$(t))});x&&x.addEventListener("click",p);E&&E.addEventListener("click",A);L&&L.addEventListener("click",q);a&&a.addEventListener("click",e=>{e.target===a&&p()});document.addEventListener("keydown",e=>{a.classList.contains("active")&&(e.key==="Escape"?p():e.key==="ArrowRight"?A():e.key==="ArrowLeft"&&q())});
